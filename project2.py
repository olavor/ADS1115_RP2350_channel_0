...
# 0xC5 = Canal 0 (AIN0), Ganho +/- 2.048V, Single-shot
...
# Aguarda a conversão (8ms para 128SPS, aguardamos 10ms por margem)
time.sleep_ms(10)
...
print("Leitura AIN0 Bruta:", raw_value)
print("Tensão AIN0 (V):", voltage)